...
public class ProfileActivity extends MvpActivity<ProfileView, ProfilePresenter> implements ProfileView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new ProfileFragmentPagerAdapter(event, getSupportFragmentManager(), ProfileActivity.this));
        //viewPager.setAdapter(new ProfileFragmentPagerAdapter(getFragmentManager(),ProfileActivity.this));
