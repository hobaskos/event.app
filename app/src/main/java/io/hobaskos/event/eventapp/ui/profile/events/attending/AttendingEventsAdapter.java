...
public class AttendingEventsAdapter extends PagedRecyclerAdapter<Event> {

    public AttendingEventsAdapter(List<Event> items, Context context, Action1<Event> onItemClick) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case 0:
                AttendingEventsAdapter.EventViewHolder eventHolder = (AttendingEventsAdapter.EventViewHolder) holder;
    ...
    protected ItemViewHolder newItemViewHolder(View view) {
        return new AttendingEventsAdapter.EventViewHolder(view);
    }
